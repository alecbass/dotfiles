...
--
-- Fix Nvidia Chromium flickering
...
local grimScreenshotCommand =
	[[grim -g "$(slurp -w 0)" "$HOME/Pictures/Screenshots/$(date +'%s_grim.png')" && wl-copy < "$HOME/Pictures/Screenshots/$(ls -Art "$HOME/Pictures/Screenshots" | tail -n 1)"]]
